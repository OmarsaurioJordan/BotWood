function s_angulo16(argument0) {
	//para calcular la direccion de entre 16 sprites
	//arg0: aargument0ulo dado
	//ret: numero 0 a 15
	...
	else if argument0 <= 326
	{
	    resultado = 14;
	}
	else if argument0 <= 349
	{
	    resultado = 15;
	}
	else
