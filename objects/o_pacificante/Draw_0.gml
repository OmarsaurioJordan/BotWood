...
if room == w_menu or room == w_configuracion
{
    ...
    {
        case 1:
            eso = "Siege, fight vs towers#destroy 5 edifices#they are in center of map"; break;
        case 2:
            eso = "Siege, fight vs towers#destroy 3 edifices#they are at north of map"; break;
        case 3:
            eso = "Siege, fight vs towers#destroy 1 edifice#it are at north of map"; break;
        case 4:
        ...
        case 13:
            eso = "Defence, fight vs dummy bots#Protect 1 edifice#bots come from south"; break;
        case 14:
            eso = "Defence, fight vs dummy bots#Protect 3 edifices#bots come from south"; break;
        case 15:
            eso = "Defence, fight vs dummy bots#Protect 5 edifices#bots come from everywhere"; break;
        case 16:
        ...
        case 18:
            eso = "Only Distance, fight vs towers#you start surrounded by them"; break;
        case 19:
    ...
    if eso == "" and room == w_configuracion {
        ...
        if point_in_rectangle(mouse_x, mouse_y,
            ...
            eso = "type the LAN IP-Mask#find it in Windows#with cmd: ipconfig#ex: 192.168.1.3-255.255.255.0";
        }
    }
	if eso == "" and room == w_menu {
        if point_distance(mouse_x, mouse_y,
				room_width / 2, room_height / 2) < 64 {
            eso = "Click here to go to#the D door#is our recommendation";
        }
    }
}
else // lobby
