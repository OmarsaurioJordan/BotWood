...
{
    draw_text_transformed_colour(x, 0, string_hash_to_newline(string(o_game.minutos) + ":0" +
        string(o_game.segundos)), 1.5, 1.5, 0, c_white, c_white, c_white, c_white, 1);
}
else
{
    draw_text_transformed_colour(x, 0, string_hash_to_newline(string(o_game.minutos) + ":" +
        string(o_game.segundos)), 1.5, 1.5, 0, c_white, c_white, c_white, c_white, 1);
}
...
if instance_exists(o_creador)
{
    ...
    if room == w_editor
    {
        ...
        draw_text_ext_transformed_colour(32, 64,
            string_hash_to_newline("EDITOR:#Here you can create a map to play, all the modalityes are open to you..." +
